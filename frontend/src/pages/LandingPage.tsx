...
import { ArrowRight, Globe2, LayoutGrid, LogIn, Sparkles, UserPlus } from 'lucide-react';
                ...
                >
                  ...
                  <div className="p-4 flex flex-col gap-3 text-sm">
                    ...
                    <button
                      ...
                      className="mt-auto inline-flex items-center justify-between gap-2 w-full text-xs px-3 py-2 rounded-full bg-slate-900/90 border border-slate-700/80 text-slate-100 hover:border-royal/80 hover:text-royal hover:bg-slate-900 transition-colors"
                    >
